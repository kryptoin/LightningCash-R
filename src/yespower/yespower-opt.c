...
#define PWXFORM                                                                \
  PWXFORM_ROUND PWXFORM_ROUND PWXFORM_ROUND PWXFORM_ROUND PWXFORM_ROUND        \
      PWXFORM_ROUND
...
static void smix1(uint8_t *B, size_t r, uint32_t N, salsa20_blk_t *V,
...
static void smix(uint8_t *B, size_t r, uint32_t N, salsa20_blk_t *V,
                 salsa20_blk_t *XY, pwxform_ctx_t *ctx) {
#if _YESPOWER_OPT_C_PASS_ == 1
