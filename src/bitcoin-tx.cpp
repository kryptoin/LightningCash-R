...
static int AppInitRawTx(int argc, char *argv[]) {
  ...
  if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||
      gArgs.IsArgSet("-help")) {
    std::string strUsage =
        strprintf(_("%s lightningcashr-tx utility version"), _(PACKAGE_NAME)) +
        " " + FormatFullVersion() + "\n\n" + _("Usage:") + "\n" +
        "  lightningcashr-tx [options] <hex-tx> [commands]  " +
        _("Update hex-encoded lightningcashr transaction") + "\n" +
        "  lightningcashr-tx [options] -create [commands]   " +
        _("Create hex-encoded lightningcashr transaction") + "\n" + "\n";
