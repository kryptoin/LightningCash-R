...
public:
  ...
  CBlockIndex *FirstBlock() const { return vChain[1]; }

  CBlockIndex *FirstHiveBlock() const { return vChain[126]; }

  CBlockIndex *varForkBlock() const { return vChain[67777]; }

  CBlockIndex *speedUpdate() const { return vChain[76325]; }

  CBlockIndex *varForkBlocktestnet() const { return vChain[500]; }

  CBlockIndex *preForkBlock() const { return vChain[67776]; }

  CBlockIndex *preForkBlocktestnet() const { return vChain[499]; }

  CBlockIndex *firstLoop() const { return vChain[33217]; }

  CBlockIndex *reverting() const { return vChain[163206]; }
