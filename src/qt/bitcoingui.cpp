...
BitcoinGUI::BitcoinGUI(const PlatformStyle *_platformStyle,
  ...
  QString windowTitle = tr("LightningCashr Coin - ");
...
void BitcoinGUI::createActions() {
  ...
  receiveCoinsAction->setStatusTip(
      tr("Request payments (generates QR codes and lightningcashr: URIs)"));
  ...
  aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"),
                            tr("&About LightningCashr Coin"), this);
  ...
  signMessageAction->setStatusTip(tr("Sign messages with your LightningCashr "
  ...
  showHelpMessageAction->setStatusTip(
      tr("Show the %1 help message to get a list with possible LightningCashr "
  ...
  importPrivateKeyAction->setToolTip(
      tr("Import a Lightning or LightningCashr private key"));
...
void BitcoinGUI::updateNetworkState() {
  ...
  if (clientModel->getNetworkActive()) {
    tooltip =
        tr("%n active connection(s) to LightningCashr network", "", count) +
...
void BitcoinGUI::message(const QString &title, const QString &message,
  ...
  QString strTitle = tr("LightningCashr Coin");
  ...
  if (style & CClientUIInterface::MODAL) {
    ...
    if (!(buttons =
              (QMessageBox::StandardButton)(style &
