...
QString BitcoinUnits::longName(int unit) {
  ...
  case mBTC:
    return QString("mLNCR");
  case uBTC:
    return QString::fromUtf8("μLNCR");
  default:
    return QString("???");
  }
}
...
QString BitcoinUnits::description(int unit) {
  ...
  case mBTC:
    return QString("Milli-LNCR (1 / 1" THIN_SP_UTF8 "000)");
  case uBTC:
    return QString("Micro-LNCR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
  default:
    return QString("???");
  }
}
